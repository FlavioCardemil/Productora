...
class ConcertsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create concert" do
    assert_difference('Concert.count') do
      post concerts_url, params: { concert: { cant: @concert.cant, date: @concert.date, duration: @concert.duration, place: @concert.place } }
    end
  ...
  test "should update concert" do
    patch concert_url(@concert), params: { concert: { cant: @concert.cant, date: @concert.date, duration: @concert.duration, place: @concert.place } }
