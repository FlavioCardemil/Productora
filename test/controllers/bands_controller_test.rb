...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { crew: @band.crew, date_debout: @band.date_debout, name: @band.name, type: @band.type } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { crew: @band.crew, date_debout: @band.date_debout, name: @band.name, type: @band.type } }
